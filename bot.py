        ...
        if 'message' in update:
            ...
            if text == '/start':
                ...
                if text == "📢 Про нас":
                    ...
                    send_message(
                        chat_id,
                        "Оберіть тип події, яку хочете повідомити: /n Використовуються для класифікації надзвичайних ситуацій та інших подій за їхнім походженням або характером: /n Техногенні: Події, пов'язані з діяльністю людини (аварії, катастрофи на виробництві/транспорті)./n Природні: Події, спричинені силами природи (землетруси, повені, буревії). /n Соціальні: Події, пов'язані з суспільними конфліктами або масовими заворушеннями. /n Воєнні: Події, пов'язані з військовими діями або конфліктами. /n Розшук: Дії, спрямовані на пошук зниклих осіб або злочинців. /n Інші події: Загальна категорія для всього, що не вписується в попередні визначення.",
